// Findings
// Contains consistently takes the longest, followed by Enqueue, then Dequeue, then Peek
// I was surprised to see just how quick each process actually was, I had to modify my results to display in microseconds, and when that wasn't small enough I had to use nanoseconds. That still wasn't small enough, so I had to use groups of 50 to find actual time measurements
